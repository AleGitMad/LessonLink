...
class TestActiveBookings {
    ...
    void existingData() throws Exception {
        ...
        assertEquals(bookingBean.getLesson().getTeacherId(), lesson.getTeacherId());
        assertEquals(bookingBean.getLesson().getStudentId(), lesson.getStudentId());
        assertEquals(bookingBean.getLesson().getDateTime().toString(), lesson.getDateTime().toString().substring(0, lesson.getDateTime().toString().length() - 10));
        assertEquals(bookingBean.getLesson().getIsConfirmed(), lesson.getIsConfirmed());
